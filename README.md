...
<img width="520" height="408" alt="image" src="https://github.com/user-attachments/assets/a60295a1-a2b5-4194-b9c6-3b20bf4da187" />


### Display the image as Grayscale image:
<img width="565" height="466" alt="image-1" src="https://github.com/user-attachments/assets/44b85207-0f70-4e3d-aa8e-c04f6bb6851e" />


### Crop the image to extract any specific (Eagle alone) object from the image:
<img width="391" height="468" alt="image-2" src="https://github.com/user-attachments/assets/a76d0883-9bdf-4f5e-825f-c1b4c5177c57" />



### Flip the cropped image horizontally:
<img width="470" height="469" alt="image-3" src="https://github.com/user-attachments/assets/8422ee38-e151-4e5a-b2cf-3baf515684d8" />


### Add the following text to the dark area at the bottom of the image (centered on the image):
<img width="554" height="321" alt="image-4" src="https://github.com/user-attachments/assets/d11d39f1-55c3-47f1-a335-f5ed00468352" />


### Draw a magenta rectangle that encompasses the launch tower and the rocket.
<img width="673" height="394" alt="image-5" src="https://github.com/user-attachments/assets/d667e356-9c61-4de6-8c37-b21d0c0fdc00" />


### Display the images (Original Image, Darker Image, Brighter Image).
<img width="782" height="222" alt="image-6" src="https://github.com/user-attachments/assets/58c481c0-007e-493f-8e4b-41231a8865ae" />

### Display the images (Original, Lower Contrast, Higher Contrast).
<img width="787" height="217" alt="image-7" src="https://github.com/user-attachments/assets/dfa7ff01-2a82-4ddd-9d57-f430318ce0db" />

### Split the image (boy.jpg) into the B,G,R components & Display the channels.
<img width="777" height="222" alt="image-8" src="https://github.com/user-attachments/assets/5306b225-fa7c-45ce-83ae-fcd245c06a3f" />


### Split the image into the H, S, V components & Display the channels.
<img width="776" height="225" alt="image-9" src="https://github.com/user-attachments/assets/42b67029-fee3-4ffe-90f1-c8673bea63f6" />

### Merged the H, S, V, display along with orginal image
<img width="777" height="333" alt="image-10" src="https://github.com/user-attachments/assets/d08dfc52-96ad-44e2-adef-2a8b2be74c47" />
